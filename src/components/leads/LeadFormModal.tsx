      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3 mt-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-muted-foreground mb-1 block">Subs (K)</label>
            ...
            <div>
              <label className="text-xs text-muted-foreground mb-1 block">Uploads / mo</label>
          ...
          <div>
            <label className="text-xs text-muted-foreground mb-1 block">Email #2</label>
